...
water_val = 0  # Water value: the raw reading with the probe standing in water. Typically around 280 on a 5 V board. Measure it, do not assume it.  # min: 0  max: 1023
