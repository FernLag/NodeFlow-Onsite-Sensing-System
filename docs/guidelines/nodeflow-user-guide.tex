...
% deliberately minimal. only geometry, xcolor and hyperref are needed, and all
% three ship with every latex distribution including basictex. the boxes and
% the screen mock-up below are built from core latex so nothing has to be
% installed with tlmgr before this will build.
...
% a boxed note, built from core latex
\newsavebox{\nfbox}
\newenvironment{note}
  {\par\medskip\noindent
   \begin{lrbox}{\nfbox}\begin{minipage}{0.94\linewidth}\vspace{2pt}}
  {\vspace{2pt}\end{minipage}\end{lrbox}%
   \fcolorbox{leaf}{paper}{\usebox{\nfbox}}\par\medskip}

\newenvironment{caution}
  {\par\medskip\noindent
   \begin{lrbox}{\nfbox}\begin{minipage}{0.94\linewidth}\vspace{2pt}}
  {\vspace{2pt}\end{minipage}\end{lrbox}%
   \fcolorbox{warn}{white}{\usebox{\nfbox}}\par\medskip}
